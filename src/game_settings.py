...
class Settings:
    ...
    new_game_delay = 10                      # Automatically start a new game after this many secods

    food_spawning = 2                       # Defines the number of food
    ...
    resuffling_food_intrv = 60               # Sets interval after which all current food is destroyd and recreated in random locations
